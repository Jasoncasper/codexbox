use codexbox_core::relay_config::{
...
use codexbox_core::settings::{RelayContextSelection, RelayMode, RelayProfile, RelayProtocol};
...
fn apply_chat_protocol_relay_points_codex_to_local_responses_proxy() {
    ...
    let result = codexbox_core::relay_config::apply_relay_config_to_home_with_protocol(
        temp.path(),
...
fn apply_relay_files_with_context_selection_writes_all_global_context() {
    ...
    codexbox_core::relay_config::apply_relay_files_to_home_with_context(
        temp.path(),
        r#"model_provider = "custom"
[model_providers.custom]
name = "custom"
...
fn apply_relay_files_with_context_rejects_invalid_context_token_values() {
    ...
    let error = codexbox_core::relay_config::apply_relay_files_to_home_with_context(
        temp.path(),
        r#"model_provider = "custom""#,
        r#"{"OPENAI_API_KEY":"sk-new"}"#,
        "",
