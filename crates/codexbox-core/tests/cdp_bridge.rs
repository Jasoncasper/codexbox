use codexbox_core::assets;
use codexbox_core::bridge::{self, BRIDGE_BINDING_NAME};
use codexbox_core::cdp::{CdpTarget, pick_page_target};
...
fn injection_script_prefixes_helper_url_and_sponsor_images() {
    ...
    assert!(script.contains(codexbox_core::version::VERSION));
...
fn injection_script_marks_diagnostic_build_and_reports_script_loaded() {
    ...
    assert!(script.contains(codexbox_core::assets::DIAGNOSTIC_BUILD_ID));
