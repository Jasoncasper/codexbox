...
pub fn install_entrypoints() -> InstallActionResult {
    codexbox_core::install::install_entrypoints(&InstallOptions::default())
}

pub fn uninstall_entrypoints(options: InstallOptions) -> InstallActionResult {
    codexbox_core::install::uninstall_entrypoints(&options)
}

pub fn repair_shortcuts() -> InstallActionResult {
    codexbox_core::install::repair_entrypoints(&InstallOptions::default())
}
